...
export default createReactClass({
  ...
  render() {
    ...
    return <InputGroup
      ...
      <input readOnly ref="hiddenInput" type="hidden" id={this.props.id} name={this.props.name} value={this.state.value || ''} data-formattedvalue={this.state.value ? this.state.inputValue : ''} />
