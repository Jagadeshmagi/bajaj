...
const Value = React.createClass({
	...
	renderLabel () {
		...
		let tag = ReactDOM.findDOMNode(this.refs.Selectvaluelabel)
		console.log("this.props.onClick", this.props.onClick, this.props.value.href, this.props.children)
		console.log("consdfasfds",  ReactDOM.findDOMNode(this.refs.Selectvaluelabel))
		return this.props.onClick || this.props.value.href ? (
			...
			<span ref="Selectvaluelabel" className={className} role="option" aria-selected="true" id={this.props.id}>
				{this.props.children}
			</span>
		);
	},
