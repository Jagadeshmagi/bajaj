...
import {getAssetGroupStatus} from 'helpers/context'
...
export const DiscoveryStatus = React.createClass({
  getInitialState() {
    return {
      assetGroupId: this.props.group.assetGroupId,
      statusText: "-",
      pollForStatus: false
    };
  },
  componentDidMount(){
    ...
    this.setState({statusText:this.props.group.discovery_status})
  },
  ...
  //
  //   if(assetGroupId > 0){
  //     return getAssetGroupStatus(assetGroupId)
  //     .then((workLogStr) => {
  ...
  //     getScoreWithAssetGroupId(this.props.group.id)
